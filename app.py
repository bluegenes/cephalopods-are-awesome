...
#                'puzzles to challenge the octopuses\' brains. :: http://bit.ly/17grqte',
            ...
            'Squid have three hearts that pump blue blood through their body! :: x',
            'Squid move through the water head first instead of tail first :: x',
            'Some species of squid are able to glow in the dark! :: x',
            'The giant squid has eyeballs that are bigger than your head! :: x',
            'The giant squid is the largest invertebrate in the world' :: x,
            'Squid are believed to be the fastest invertebrates in the world :: x',
            'Some squid live more than 13,000 feet below the ocean surface!' :: x,
            'The largest known Colossal Squid weighed more than 1,000 pounds! :: x',
            'The giant squid is as long as a whale! :: x',
            'Giant squid can regenerate their tentacles. :: x',
            'Opalescent squid tend to spawn around the full moon. :: x',
            'Fishermen use high-powered lights to attract squid to the surface :: x',
            'Squid are a major source of food for sea lions and seabirds off the California Coast. :: x',
