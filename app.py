...
#                'puzzles to challenge the octopuses\' brains. :: http://bit.ly/17grqte',
            ...
            'Squid have three hearts that pump blue blood through their body! :: https://twitter.com/saltyscientist',
            'Squid move through the water head first instead of tail first :: https://twitter.com/saltyscientist',
            'Some species of squid are able to glow in the dark! :: https://twitter.com/saltyscientist',
            'The giant squid has eyeballs that are bigger than your head! :: https://twitter.com/saltyscientist',
            'The giant squid is the largest invertebrate in the world :: https://twitter.com/saltyscientist',
            'Squid are believed to be the fastest invertebrates in the world :: https://twitter.com/saltyscientist',
            'Some squid live more than 13,000 feet below the ocean surface! :: https://twitter.com/saltyscientist',
            'The largest known Colossal Squid weighed more than 1,000 pounds! :: https://twitter.com/saltyscientist',
            'The giant squid is as long as a whale! :: https://twitter.com/saltyscientist',
            'Giant squid can regenerate their tentacles. :: https://twitter.com/saltyscientist',
            'Opalescent squid tend to spawn around the full moon. :: https://twitter.com/saltyscientist',
            'Fishermen use high-powered lights to attract squid to the surface :: https://twitter.com/saltyscientist',
            'Squid are a major source of food for sea lions and seabirds off the California Coast. :: https://twitter.com/saltyscientist',
